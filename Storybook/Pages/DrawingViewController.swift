...
class DrawingViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        flightButton.setImage(UIImage(systemName: "pencil.and.scribble", withConfiguration: birdConfig), for: .normal)
    ...
    private func createCompositeImage() -> UIImage {
        guard let lineArt = UIImage(named: "bird-line-art"),
            ...
            return canvasView.drawing.image(from: canvasView.bounds, scale: view.traitCollection.displayScale)
        }
